export default [
  ...
  {
    name: 'pintOS',
    description: 'Pintos is a project widely used for teaching <strong>operating systems design</strong>. We started with a basic version and implemented functionality like <strong>thread scheduling</strong> and <strong>file handling</strong>.',
    tags: ['C', 'asm', 'Operating Systems'],
    image: ''
  },
  {
